    ...
    <div v-else class="layout__box">
        ...
        <div class="layout__body">
            ...
            <div class="form__group">
                ...
                <!-- <input required type="text" name="topic" id="cateogry" list="cateories" /> -->
                <p v-if="loading">Loading...</p>
                <select id="cateories" v-model="model.category.parent_id">
...
export default {
    ...
    methods: {
        createCategory() {
            var mythis = this;
            axios
                .post("/api/categories/new-category", this.model.category)
                .then((res) => {
                    console.log(this.model.category.parent_id);
